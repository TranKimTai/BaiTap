...
namespace QuanLyPhongKham.BUS
{
    public class PhieuKhamBUS
    {
        ...
        public void InsertChiTietDV(int maPhieu, int maDV, int soLuong, decimal donGia, decimal thanhTien)
        {
            dal.InsertChiTietDV(maPhieu, maDV, soLuong, donGia, thanhTien);
        }
